      ...
      {step === "select-mode" && (
        <div className="inputs-row">
          ...
          >
            ...
            <div style={{ fontSize: '0.85rem', opacity: 0.8 }}>Tutti giocano normalmente</div>
          </button>
          ...
          >
            ...
            <div style={{ fontSize: '0.85rem', opacity: 0.8 }}>L'host gestisce il gioco</div>
          </button>
          ...
          >
            ...
            <div style={{ fontSize: '0.85rem', opacity: 0.8 }}>Gara contro il tempo</div>
          </button>
